...
#edges = {(1,1): [(1,1),(2,2)], (1,2): [(1,1),(1,2)],(2,1):[(1,1),(2,1)],(2,2):[(1,1),(2,2)]}
a =list(strongly_connected_components_path(vertices, edges))
for x in a:
    x= list(a)
print(a)
print(type(strongly_connected_components_path(vertices, edges)))
print(strongly_connected_components_path(vertices, edges))
for scc in strongly_connected_components_path(vertices, edges):
    print(scc)